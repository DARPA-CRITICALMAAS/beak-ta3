...
def main(args):
    ...
    # Choose data path
    ROOT_PATH = BASE_PATH / "PROCESSED" / "regional_102008_500_poco_southwest"
    PATH_STD_DATA = ROOT_PATH / "unified_scaled_std"
    PATH_LOG_DATA_GEOPHYSICS = ROOT_PATH / "unified_scaled_log" / "geophysics"
    PATH_LOG_DATA_GEOCHEM = ROOT_PATH / "unified_imputed_mean_scaled_log"
